...
//pagination의 뜻 : 목록을 일정 페이지로 분할해서 원하는 페이지를 볼 수있게 하는것 . == 페이징 처리 


//Pagination객체 : 페이징 처리에 필요한 값을 모아두고, 계산하는 객체 
...
public class Pagination {
	...
	private int maxPage;		// 마지막 페이지 번호 (minpage: 당연히 1)
	...
	private void calculate() {
		...
		if(currentPage<=pageSize) { // pageSize = 10.currentPage 10 이하 일때!
			prevPage=1;
		}else {
		...
		//nextPage : ">" 클릭시 이동할 페이지 번호 다음페이지 번호 목록중 시작 번호
