...
@Service //비즈니스로직처리 역할 명시 +BEAN 등록
@Slf4j
public class MemberServiceImpl implements MemberService {
	
	//등록된 BEAN 중에서 MemberMapper 와 같은 타입 or 상속관계인 BEAN을 찾아 의존성 주입(DI)
	@Autowired //의존성 주입(DI)
	private MemberMapper mapper;
	
	
	//Bcrypt 암호화 객체 의존성 주입(DI) - SecurityConfig파일 참고하기!!
	@Autowired
